...
-   **Seminario 1** (*26 septiembre*) - MVC y variantes + interfaces de usuario + LLM

-   **Seminario 2** (*17 octubre*) - Caso de estudio: Software architecture patterns

-   **Seminario 3** (*30/31 octubre*) - Conjunto con EI1048. Relacionado con proyecto común

-   **Seminario 4** (*20/21 noviembre*) - Conjunto con EI1048. Relacionado con proyecto común

-   **Seminario 5** (*12 diciembre*) - Comunicación oral del proyecto
